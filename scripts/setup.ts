 ...
 * user from FIRST_ADMIN_EMAIL / FIRST_ADMIN_NAME.
 *
...
if (adminEmail) {
  ...
  try {
    run(`pnpm create:admin ${adminEmail} "${adminName}"`);
  } catch {
    console.log("  Admin already exists or could not be created — skipping.");
  }
} else {
  console.log(
